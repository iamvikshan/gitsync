...
#
# Options:
#   --repo <url>       Override the target repository URL (default: https://github.com/iamvikshan/advanced-git-sync)
...
DEFAULT_TARGET_REPO="https://github.com/iamvikshan/advanced-git-sync"
